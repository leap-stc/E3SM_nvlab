...
case_prefix = 'v2rh_unet_mc_huber_1y_withstratconstraint'
...
#---------------------------------------------------------------------------------------------------
# MMF_NN_EMULATOR
f_torch_model = '/pscratch/sd/z/zeyuanhu/hugging/E3SM-MMF_ne4/saved_models_wrapper/v2rh_mc_fix_huber.pt'
